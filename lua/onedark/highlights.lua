...
hl.common = {
    ...
    MatchParen = { fg = c.fg, bg = c.purple },
    NonText = { fg = c.grey },
...
hl.treesitter = {
    ...
    TSFuncBuiltin = { fg = c.blue, fmt = cfg.code_style.functions },
    TSFuncMacro = { fg = c.blue, fmt = cfg.code_style.functions },
...
hl.plugins.fidget = {
    FidgetTitle = { fg = c.fg, bg = c.none, fmt = "bold" },
    FidgetTask = { fg = c.fg, bg = c.none, fmt = "italic" },
}
...
hl.plugins.outline = {
    FocusedSymbol = { fg = c.purple, bg = c.none, fmt = "bold" },
    AerialLine = { fg = c.purple, bg = c.bg0, fmt = "bold" },
}

hl.plugins.ts_rainbow = {
    rainbowcol1 = colors.Blue,
    rainbowcol2 = colors.Orange,
    rainbowcol3 = colors.Cyan,
    rainbowcol4 = colors.Purple,
    rainbowcol5 = colors.Green,
